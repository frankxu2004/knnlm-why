...
centroids = np.load(ckpt_path + 'spherical_centroids.npy')
...
np.save(ckpt_path + 'spherical_dist.npy', np.concatenate(dists))
np.save(ckpt_path + 'spherical_centroid_ids.npy', np.concatenate(centroid_ids))
