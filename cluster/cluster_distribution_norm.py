...
dists = np.load(ckpt_path + 'norm_dist.npy')
centroid_ids = np.load(ckpt_path + 'norm_centroid_ids.npy')
...
sparse.save_npz(ckpt_path + 'norm_cluster_count.npz', freq_mat)

freq_mat = sparse.load_npz(ckpt_path + 'norm_cluster_count.npz')
...
sparse.save_npz(ckpt_path + 'norm_cluster_freq.npz', freq_mat)
...
df.to_csv(ckpt_path + 'norm_cluster.csv')
