...
np.save(dstore_filename.split('/')[-1] + '_faiss_mask_recomp.npy', np.concatenate(all_probs))
np.save(dstore_filename.split('/')[-1] + '_faiss_mask_recomp_knns.npy', np.concatenate(all_knns, axis=0))
np.save(dstore_filename.split('/')[-1] + '_faiss_mask_recomp_dists.npy', np.concatenate(all_dists))
