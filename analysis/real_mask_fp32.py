...
np.save(dstore_filename.split('/')[-1] + '_real_mask_fp32.npy', np.concatenate(all_probs))
np.save(dstore_filename.split('/')[-1] + '_real_mask_fp32_knns.npy', np.concatenate(all_knns, axis=0))
