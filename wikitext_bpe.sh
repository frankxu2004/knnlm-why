...
python eval_lm.py data-bin/wikitext103-bpe \
    ...
    --dstore-size 162735285 --model-overrides "{'knn_keytype': 'last_ffn_input'}" \
    --save-knnlm-dstore --fp16 --dstore-fp16

# build index
python build_dstore.py \
    --dstore_mmap checkpoints/wikitext103-bpe-tied/dstore \
    --dstore_size 112735285 \
    --faiss_index checkpoints/wikitext103-bpe-tied/dstore.index \
...
python eval_lm.py data-bin/wikitext103-bpe \
    ...
    --indexfile checkpoints/wikitext103-bpe-tied/dstore.index  \
    --model-overrides "{'knn_keytype': 'last_ffn_input'}" \
    --k 1024 --lmbda 0.25 --dstore-size 112735285 --knn-keytype last_ffn_input \
...
python eval_lm.py data-bin/wikitext103-bpe \
    ...
    --sample-break-mode complete --max-tokens 3072 \
    --context-window 2560 --softmax-batch 1024 \
    --gen-subset test --dstore-filename checkpoints/wikitext103-bpe-tied/dstore \
    --indexfile checkpoints/wikitext103-bpe-tied/dstore.index  \
    --model-overrides "{'knn_keytype': 'last_ffn_input'}" \
    --k 1024 --lmbda 0.25 --dstore-size 112735285 --knn-keytype last_ffn_input \
